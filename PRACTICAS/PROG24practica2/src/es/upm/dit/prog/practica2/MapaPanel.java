...
public class MapaPanel extends JPanel {
	...
	public void init(Dron dron1, Mision mision, long tini, long tfin, long step) {
		this.dron1 = dron1;
		this.mision = mision;
		this.tini = tini;
		this.tfin = tfin;
    ...
    public void step() {
    	if (this.t > this.tfin) {
 		...
 		this.dron1.mover(this.t);
 		this.mision.update(this.t);
 		this.f.repaint();    	
    	this.t += this.step;
    }	
	...
	public void paintComponent(Graphics g) {
		...
		if (this.mision != null)
			this.paintMision(g, this.mision);
		if (this.dron1 != null)
			this.paintDron (g, this.dron1);
		g.setColor(c);
	}
    ...
    public void paintDron(Graphics g, Dron d) {
    	Color c = g.getColor();
